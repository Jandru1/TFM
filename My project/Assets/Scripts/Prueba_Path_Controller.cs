...
namespace MotionMatching
{
    ...
    public class Prueba_Path_Controller : MotionMatchingCharacterController
    {
        ...
        {
            GameObject Joe = gameObject.transform.parent.GetChild(2).gameObject;
            Agent a = Joe.GetComponent<Agent>();
            Path[0].Position.x = Joe.transform.position.x;
            Path[0].Position.y = Joe.transform.position.y;
            Path[1].Position.x = a.GetGoal().x;
            Path[1].Position.y = a.GetGoal().y;
        }
        ...
        public override float3 GetWorldInitPosition()
        {
            GameObject Joe = gameObject.transform.parent.GetChild(2).gameObject;
            Agent a = Joe.GetComponent<Agent>();
            return new float3(a.GetInitPosition().x, 0, a.GetInitPosition().y);
